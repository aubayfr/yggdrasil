...
function Set-StartURL {
    ...
    $Config.startURL = gum input --width=0 --placeholder "https://raw.githubusercontent.com/username/project/master/script.ps1" --value="https://raw.githubusercontent.com/aubayfr/yggdrasil/refs/heads/master/Install-Windows.ps1"
